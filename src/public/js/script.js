...
$ = jQuery = require('jquery'); // Required for bootstrap
require('bootstrap');

$(document).ready(function() {
  require('./modules/tracking-tags');
});

},{"./modules/tracking-tags":16,"bootstrap":1,"jquery":14}],16:[function(require,module,exports){
var $ = require('jquery');
